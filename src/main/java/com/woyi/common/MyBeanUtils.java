...
public class MyBeanUtils extends org.apache.commons.beanutils.BeanUtils {
	...
	/**
	 * 将传入对象的属性和值以key和value的形式保存到map中
	 * 
	 * @param map
	 * @param bean
	 */
	@SuppressWarnings("unchecked")
	public static void copyBean2Map(@SuppressWarnings("rawtypes") Map map, Object bean) {
	 ...
	 * @throws InvocationTargetException
	 */
	public static void copyMap2Bean(Object bean, @SuppressWarnings("rawtypes") Map properties)
	 ...
	 * @throws InvocationTargetException
	 */
	public static void copyMap2Bean_Nobig(Object bean, @SuppressWarnings("rawtypes") Map properties)
			throws IllegalAccessException, InvocationTargetException {
		// Do nothing unless both arguments have been specified
		if ((bean == null) || (properties == null)) {
			return;
